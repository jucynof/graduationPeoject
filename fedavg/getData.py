...
class getData:
    ...
    def __init__(self, config):
        ...
        self.test_dataset = torchvision.datasets.FashionMNIST("./dataset", train=False, download=True,
                                                         transform=transformTest)
        # self.train_dataset = torchvision.datasets.MNIST("./dataset", train=True, download=True, transform=transformTrain)
        # self.test_dataset = torchvision.datasets.MNIST("./dataset", train=False, download=True, transform=transformTest)
